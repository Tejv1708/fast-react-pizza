...
function Button({ children, disabled, to, type, onClick }) {
    ...
    const style = {
        ...
        secondary:
            "inline-block border-2 border-stone-300 rounded-full   font-semibold uppercase tracking-wide text-stone-400 transition-colors duration-300 hover:bg-stone-300 focus:outline-none focus:bg-stone-300 focus:ring focus:ring-stone-200 focus:ring-offset-2 disabled:cursor-not-allowed px-4 py-2.5 sm:px-6 sm:py-3.5 hover:text-stone-800 focus:text-stone-800",
    }
    if (to)
        return (
